...
class GamesClient {
    ...
    public BaseImageResponse getGameImages(List<Integer> id) {
        ...
        return Unirest.get(TheGamesDbClient.BASE_URL + "/v1/Games/Images")
    ...
    public List<Game> getGameById(List<Integer> id) {
        ...
        return Unirest.get(TheGamesDbClient.BASE_URL + "/v1/Games/ByGameID")
                .queryString("apikey", apiKey)
                .queryString("id", ids)
    ...
    public List<Game> getGameByName(String name) {
        return Unirest.get(TheGamesDbClient.BASE_URL + "/v1.1/Games/ByGameName")
                .queryString("apikey", apiKey)
    ...
    public List<Game> getGameByPlatform(List<Integer> platformId) {
        ...
        return Unirest.get(TheGamesDbClient.BASE_URL + "/v1/Games/ByPlatformID")
                .queryString("apikey", apiKey)
                .queryString("id", ids)
                .queryString("fields", fields)
                .asObject(new GenericType<BaseResponse<BaseGameResponse>>() {
    ...
    public List<Game> getUpdateGame(int lastEditId) {
        return Unirest.get(TheGamesDbClient.BASE_URL + "/v1/Games/Updates")
                .queryString("apikey", apiKey)
